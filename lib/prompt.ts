...
- **Cite instruments, never RegSpine's own files.** The \`rule\` field is read by compliance and design teams, so it must name the regulatory instrument and the requirement — never an internal reference like "dark-patterns.md #14", "checklist #13", or a rulebook filename. Those are your working notes, not a citation.
